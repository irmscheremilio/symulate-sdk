...
// Merged metadata:
// {
//   category: "Electronics",      ← From config
//   brand: "SuperTech",           ← Overridden at runtime
//   priceRange: { min: 50, ... }, ← From config
//   targetMarket: "Budget..."     ← Added at runtime
// }
```
...
- Navigate to Dashboard → Database Schema
...
- Table removed
- Column removed
- Column type changed (e.g., `varchar` → `int`)
...
✅ **Single Source of Truth**: Database schema defines TypeScript types
✅ **Type Safety**: Compile-time errors for schema mismatches
✅ **Breaking Change Detection**: Catch issues before deployment
✅ **Team Coordination**: Backend and frontend stay in sync
✅ **Still AI-Powered**: Custom AI instructions work with database types
✅ **Faker Compatible**: Works in CI/CD with deterministic generation
